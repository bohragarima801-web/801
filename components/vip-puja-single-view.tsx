...
function VipPujaCountdownTimer({ puja }: { puja: any }) {
  ...
  return (
    <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-[#E8E1D5] bg-[#EFE7D8] text-[#151311] text-xs font-bold font-mono shadow-2xs">
      <Clock className="w-3.5 h-3.5 text-[#B85C24]" />
...
export function VipPujaSingleView({ puja }: SingleVipPujaProps) {
  ...
  return (
    <div className="vip-puja-theme min-h-screen bg-[#F8F4EC] text-[#151311] pb-28 relative overflow-hidden notranslate" translate="no">
      <div className="container mx-auto px-4 md:px-6 py-6 md:py-10 max-w-6xl space-y-10 relative z-10">
        
        {/* ── SECTION 1: HERO CONTAINER ── */}
        <div className="bg-white rounded-3xl border border-[#E8E1D5] p-5 sm:p-8 md:p-10 shadow-sm space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            
            {/* Left Media */}
            <div className="lg:col-span-5 relative space-y-3">
              <div className="relative aspect-[4/3] sm:aspect-[4/5] rounded-2xl overflow-hidden border border-[#E8E1D5] bg-slate-900 shadow-md group">
                <Image 
                  src={currentVipImage} 
                  alt={puja.name} 
                  fill 
                ...
                <div className="absolute top-3 left-3 right-3 flex justify-between items-center z-10">
                  <span className="inline-flex items-center gap-1 px-3 py-1 rounded-md bg-[#541F1F] text-white text-[10px] font-black uppercase tracking-wide shadow-xs border border-[#B08A45]">
                    <Crown className="h-3 w-3 text-[#B08A45]" /> VIP LIVE PUJA
                  </span>
                  <span className="bg-[#151311]/80 backdrop-blur-xs text-[#F8F4EC] text-[10px] font-bold px-2.5 py-1 rounded-md border border-white/10">
                    {categoryName}
                  </span>
                </div>
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/75 via-transparent to-transparent flex flex-col justify-end p-4 text-left pointer-events-none">
                  <span className="text-[#B85C24] font-bold text-xs flex items-center gap-1">
                    <Sparkles className="h-3.5 w-3.5" /> व्यक्तिगत 1-on-1 महा अनुष्ठान
                  </span>
                  <p className="text-xs text-[#F8F4EC] font-semibold flex items-center gap-1 mt-0.5">
                    <MapPin className="h-3.5 w-3.5 text-[#B08A45]" /> {templeLocation}
                  </p>
                </div>
              </div>
                  ...
                  {vipMediaList.map((img, i) => (
                    <button
                      ...
                      className={`relative h-12 w-12 rounded-xl overflow-hidden border-2 transition-all shrink-0 ${
                        activeMediaIndex === i ? 'border-[#B85C24] scale-105 shadow-xs' : 'border-[#E8E1D5] opacity-70 hover:opacity-100'
                      }`}
                    >
            ...
            <div className="lg:col-span-7 space-y-5 text-left">
              <div className="space-y-3">
                <div className="flex flex-wrap items-center gap-2">
                  <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#EFE7D8] text-[#B85C24] text-xs font-bold border border-[#E8E1D5]">
                    <Sparkles className="h-3.5 w-3.5" /> शास्त्रोक्त विशिष्ट सेवा
                  </div>
                  <VipPujaCountdownTimer puja={puja} />
                </div>

                <h1 className="text-2xl sm:text-3xl md:text-4xl font-black text-[#151311] leading-tight">
                  {puja.name}
                </h1>
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                {[
                  { icon: <Video className="h-4 w-4 text-[#B85C24]" />, label: '1-on-1 लाइव वीडियो' },
                  { icon: <ShieldCheck className="h-4 w-4 text-[#B85C24]" />, label: 'समर्पित निजी अनुष्ठान' },
                  { icon: <UserCheck className="h-4 w-4 text-[#B85C24]" />, label: 'आचार्य परामर्श' },
                  { icon: <Award className="h-4 w-4 text-[#B85C24]" />, label: 'नाम-गोत्र संकल्प' },
                ].map((chip) => (
                  <div key={chip.label} className="p-2.5 rounded-xl bg-[#EFE7D8]/50 border border-[#E8E1D5] flex items-center gap-2 text-xs font-bold text-[#151311]">
                    {chip.icon}
              ...
              <div className="w-full p-4 sm:p-5 rounded-2xl bg-[#F8F4EC] border border-[#E8E1D5] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-2xs">
                <div className="space-y-0.5">
                  <span className="text-[11px] text-[#665E58] block uppercase font-bold tracking-wide">न्यूनतम दक्षिणा राशि:</span>
                  <div className="text-2xl sm:text-3xl font-black text-[#151311] tracking-tight">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-6 py-3.5 rounded-xl bg-[#B85C24] hover:bg-[#d4790e] text-white font-black text-xs sm:text-sm shadow-md hover:shadow-lg transition-all duration-200 inline-flex items-center justify-center gap-2 cursor-pointer active:scale-[0.98]"
                >
        ...
        <div className="bg-white rounded-2xl border border-[#E8E1D5] p-5 sm:p-6 flex flex-col md:flex-row items-center justify-between gap-5 shadow-2xs">
          <div className="flex flex-col md:flex-row items-center gap-4 text-center md:text-left">
            <div className="relative h-16 w-16 rounded-full overflow-hidden border-2 border-[#B85C24] shadow-sm shrink-0">
              <Image 
            ...
            <div className="space-y-0.5">
              <span className="text-xs text-[#B85C24] font-bold uppercase tracking-wider block">
          ...
          <div className="flex flex-wrap gap-2 justify-center md:justify-end">
            <span className="px-3 py-1.5 rounded-xl bg-[#EFE7D8] border border-[#E8E1D5] text-[#151311] text-xs font-bold flex items-center gap-1.5">
              📜 वेद प्रमाणित आचार्य
            </span>
            <span className="px-3 py-1.5 rounded-xl bg-[#EFE7D8] border border-[#E8E1D5] text-[#151311] text-xs font-bold flex items-center gap-1.5">
        ...
        {(puja.description || (puja as any).longDescription) && (
          <div className="bg-white rounded-3xl border border-[#E8E1D5] p-6 sm:p-10 shadow-xs space-y-6 text-[#151311]">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-[#E8E1D5] pb-4">
              <div className="space-y-1 text-center sm:text-left">
                ...
                <h2 className="text-2xl sm:text-3xl font-heading font-extrabold text-[#151311] tracking-wide">
        ...
        <div className="space-y-5">
          <div className="text-center space-y-1.5">
            <span className="text-xs font-bold uppercase tracking-wider text-[#B85C24]">
              🌟 विशिष्ट अनुभव
            </span>
            <h2 className="text-2xl sm:text-3xl font-bold text-[#151311]">
              VIP महा अनुष्ठान के पावन लाभ
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            <div className="bg-white rounded-2xl border border-[#E8E1D5] p-5 space-y-2.5 text-center flex flex-col items-center shadow-2xs">
              <div className="h-11 w-11 rounded-xl bg-[#EFE7D8] border border-[#E8E1D5] text-[#B85C24] flex items-center justify-center font-bold">
                <UserCheck className="h-5 w-5" />
              </div>
              <h4 className="font-bold text-base text-[#151311]">आचार्य से सीधा परामर्श</h4>
            ...
            <div className="bg-white rounded-2xl border border-[#E8E1D5] p-5 space-y-2.5 text-center flex flex-col items-center shadow-2xs">
              ...
              <h4 className="font-bold text-base text-[#151311]">1-on-1 लाइव वीडियो दर्शन</h4>
              <p className="text-xs text-[#4A403C] leading-relaxed">
            ...
            <div className="bg-white rounded-2xl border border-[#E8E1D5] p-5 space-y-2.5 text-center flex flex-col items-center shadow-2xs">
              ...
              <h4 className="font-bold text-base text-[#151311]">नाम-गोत्र संकल्प व राजप्रसाद</h4>
              <p className="text-xs text-[#4A403C] leading-relaxed">
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl border border-[#E8E1D5] p-4 space-y-1.5 text-center shadow-2xs">
                <div className="text-lg font-black text-[#B85C24]">Step {st.step}</div>
                <h4 className="font-bold text-xs sm:text-sm text-[#151311]">{st.title}</h4>
        ...
        <div className="space-y-5 max-w-3xl mx-auto">
          ...
          <div className="space-y-2.5">
            {faqList.map((faq, idx) => {
              ...
              return (
                <div key={idx} className="bg-white rounded-2xl border border-[#E8E1D5] overflow-hidden text-left shadow-2xs">
                  <button
                    onClick={() => setOpenFaqIndex(isOpen ? null : idx)}
                    className="w-full p-4 text-left flex items-center justify-between gap-3 font-bold text-[#151311] hover:text-[#B85C24] transition-colors cursor-pointer"
                  >
                    <span className="text-xs sm:text-sm font-bold">{faq.question}</span>
                    <ChevronDown className={`h-4 w-4 text-[#B85C24] transition-transform duration-300 shrink-0 ${isOpen ? 'rotate-180' : ''}`} />
                  </button>
                  {isOpen && (
                    <div className="px-4 pb-4 text-xs sm:text-sm text-[#4A403C] leading-relaxed border-t border-[#E8E1D5] pt-3 bg-[#F8F4EC]/50">
                      {faq.answer}
                    </div>
                  )}
                </div>
      ...
      <div className="fixed bottom-0 inset-x-0 bg-white/95 backdrop-blur-md border-t border-[#E8E1D5] p-3 z-40 sm:hidden flex items-center justify-between gap-3 shadow-lg">
        <div className="min-w-0 shrink-0">
          <span className="text-[9px] text-[#665E58] uppercase font-bold block">VIP दक्षिणा राशि</span>
          <span className="text-lg font-black text-[#151311]">
            ₹{displayPrice.toLocaleString('en-IN')}
          </span>
        </div>
        <button
          onClick={() => setBookingDialogOpen(true)}
          className="px-5 py-2.5 rounded-xl bg-[#B85C24] hover:bg-[#d4790e] text-white font-extrabold text-xs shadow-md transition-all shrink-0 cursor-pointer"
        >
          VIP पूजा बुक करें ➔
        </button>
      </div>
      ...
      <Dialog open={bookingDialogOpen} onOpenChange={setBookingDialogOpen}>
        <DialogContent className="max-w-lg bg-white border border-[#E8E1D5] text-[#151311] rounded-3xl p-6 shadow-2xl notranslate" translate="no">
          <DialogHeader className="text-left space-y-1.5 border-b border-[#E8E1D5] pb-3">
            <DialogTitle className="text-lg font-black text-[#151311] flex items-center gap-2">
              <Crown className="h-5 w-5 text-[#B85C24]" /> VIP पूजा संकल्प विवरण
            </DialogTitle>
            <DialogDescription className="text-xs text-[#665E58]">
              {puja.name} • दक्षिणा: <span className="text-[#151311] font-bold">₹{displayPrice.toLocaleString('en-IN')}</span>
            </DialogDescription>
          </DialogHeader>

          <form onSubmit={handleConfirmBooking} className="space-y-3.5 pt-2 text-left">
            <div className="space-y-1">
              <Label className="text-xs font-bold text-[#151311]">मुख्य यजमान का नाम (Devotee Full Name) *</Label>
              <Input
                required
                placeholder="उदा. रमेश कुमार शर्मा"
                value={devoteeName}
                onChange={(e) => setDevoteeName(e.target.value)}
                className="bg-[#F8F4EC] border-[#E8E1D5] text-[#151311] placeholder:text-gray-400 focus:border-[#B85C24]"
              />
            </div>

            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                <Label className="text-xs font-bold text-[#151311]">व्हाट्सएप नंबर (WhatsApp No) *</Label>
                <Input
                  required
                  type="tel"
              ...
              <div className="space-y-1">
                <Label className="text-xs font-bold text-[#151311]">गोत्र (Gotra)</Label>
                <Input
            ...
            <div className="space-y-1">
              <Label className="text-xs font-bold text-[#151311]">पसंदीदा तिथि (Preferred Date)</Label>
              <Input
                type="date"
                value={selectedDate}
                onChange={(e) => setSelectedDate(e.target.value)}
                className="bg-[#F8F4EC] border-[#E8E1D5] text-[#151311] focus:border-[#B85C24]"
              />
            </div>

            <div className="space-y-1">
              <Label className="text-xs font-bold text-[#151311]">विशेष संकल्प / मनोकामना (Intention)</Label>
              <Input
            ...
            <Button
              ...
              className="w-full bg-[#B85C24] hover:bg-[#d4790e] text-white font-extrabold text-sm py-3.5 mt-2 rounded-xl shadow-md cursor-pointer flex items-center justify-center gap-2"
            >
              {bookingLoading ? (
                <>
            ...
            <div className="pt-2 text-center border-t border-[#E8E1D5]">
