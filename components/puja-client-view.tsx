  ...
  return (
    <div className="inline-flex items-center gap-2 sm:gap-3 px-3.5 py-1.5 rounded-full bg-[#EFE7D8] border border-[#E8E1D5] text-[#171513] shadow-2xs">
      ...
      <div className="flex items-center gap-1 font-mono text-xs sm:text-sm font-black text-white">
        <span className="bg-[#171513] px-1.5 py-0.5 rounded border border-[#665E58]/40">{String(timeLeft.days).padStart(2, '0')}d</span>:
        <span className="bg-[#171513] px-1.5 py-0.5 rounded border border-[#665E58]/40">{String(timeLeft.hours).padStart(2, '0')}h</span>:
        <span className="bg-[#171513] px-1.5 py-0.5 rounded border border-[#665E58]/40">{String(timeLeft.minutes).padStart(2, '0')}m</span>:
        <span className="bg-[#171513] px-1.5 py-0.5 rounded border border-[#665E58]/40">{String(timeLeft.seconds).padStart(2, '0')}s</span>
      </div>
    </div>
  )
}
  ...
  return (
    <div className="simple-puja-theme relative bg-[#F8F4EC] pb-28 sm:pb-32 font-sans antialiased text-[#171513] min-h-screen notranslate" translate="no">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-lg border border-[#E8E1D5] bg-white group">
              ...
              <div className="p-5 bg-[#F8F4EC] border-t border-[#E8E1D5] space-y-4">
                <div className="flex justify-between items-center text-sm border-b border-[#E8E1D5] pb-3">
                  ...
                  <span className="text-2xl font-black text-[#171513] font-heading">₹{basePrice.toLocaleString('en-IN')}</span>
                </div>
      ...
      <div className="w-full bg-[#FDF4E9] border-b border-[#E8E1D5] py-4 shadow-2xs">
        <div className="max-w-5xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
          <div className="flex items-center gap-2.5 p-3 bg-white rounded-2xl border border-[#E8E1D5] shadow-2xs">
            ...
            <div className="text-left min-w-0"><p className="text-xs font-bold text-[#171513] truncate">पैकेज चुनें</p><p className="text-[10px] text-[#665E58] truncate">Select Package</p></div>
          </div>
          <div className="flex items-center gap-2.5 p-3 bg-white rounded-2xl border border-[#E8E1D5] shadow-2xs">
            ...
            <div className="text-left min-w-0"><p className="text-xs font-bold text-[#171513] truncate">नाम व गोत्र दर्ज करें</p><p className="text-[10px] text-[#665E58] truncate">Name & Gotra</p></div>
          </div>
          <div className="flex items-center gap-2.5 p-3 bg-white rounded-2xl border border-[#E8E1D5] shadow-2xs">
            ...
            <div className="text-left min-w-0"><p className="text-xs font-bold text-[#171513] truncate">व्हाट्सएप लाइव वीडियो</p><p className="text-[10px] text-[#665E58] truncate">Live Video Proof</p></div>
          </div>
          <div className="flex items-center gap-2.5 p-3 bg-white rounded-2xl border border-[#E8E1D5] shadow-2xs">
            ...
            <div className="text-left min-w-0"><p className="text-xs font-bold text-[#171513] truncate">सिद्ध प्रसाद डिलीवरी</p><p className="text-[10px] text-[#665E58] truncate">Prasad at Doorstep</p></div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 mt-8 sm:mt-12 space-y-12 lg:space-y-16">
        ...
        {showPanditChoice && (
          <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xs border border-[#E8E1D5] space-y-4">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-left">
                <div className="relative h-20 w-20 sm:h-24 sm:w-24 rounded-2xl overflow-hidden border border-[#E8E1D5] shrink-0 shadow-xs bg-[#EFE7D8]">
                  <img 
                ...
                <div className="space-y-1">
                  <div className="inline-flex items-center gap-1.5 bg-[#EFE7D8] text-[#B85C24] border border-[#E8E1D5] text-[11px] font-black px-2.5 py-0.5 rounded-full uppercase tracking-wider">
                    <CheckCircle2 className="w-3.5 h-3.5 text-[#B85C24]" /> पंडित जी चॉइस उपलब्ध (Pandit Ji Choice Enabled)
                  </div>
              ...
              <div className="shrink-0 text-center sm:text-right">
                <Button 
                  onClick={() => handleScrollTo('packages')}
                  className="bg-[#171513] hover:bg-black text-white font-black px-5 py-3 rounded-xl shadow-md border-b-2 border-black/50 text-sm uppercase tracking-wide cursor-pointer"
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="border-b border-[#E8E1D5] pb-3 text-center">
                      ...
                      <div className="mt-2 flex items-baseline justify-center gap-1">
                        ...
                        <span className="text-2xl font-black text-[#171513] font-heading">₹{pkgPrice.toLocaleString('en-IN')}</span>
                      </div>
                    </div>
        ...
        <section id="temple" className="scroll-mt-32">
          <div className="bg-white rounded-3xl p-6 sm:p-10 border border-[#E8E1D5] shadow-xs space-y-6 text-[#171513]">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6 border-b border-[#E8E1D5] pb-6">
              <div className="space-y-1 text-center sm:text-left">
                <span className="text-[#B85C24] font-bold text-xs tracking-widest uppercase">📍 पवित्र स्थान विवरण</span>
            ...
            <div className="grid sm:grid-cols-3 gap-4 text-center">
              <div className="p-5 rounded-2xl bg-[#FFFDF9] border border-[#E8E1D5] space-y-1.5 shadow-2xs">
                ...
                <p className="font-bold text-sm text-[#171513]">शुद्ध वैदिक परम्परा</p>
              ...
              <div className="p-5 rounded-2xl bg-[#FFFDF9] border border-[#E8E1D5] space-y-1.5 shadow-2xs">
                ...
                <p className="font-bold text-sm text-[#171513]">समर्पित सहायता</p>
                <p className="text-xs text-[#665E58]">पूजा सम्पादन तक लगातार WhatsApp अपडेट</p>
              </div>
              <div className="p-5 rounded-2xl bg-[#FFFDF9] border border-[#E8E1D5] space-y-1.5 shadow-2xs">
                <Gift className="w-6 h-6 text-[#B85C24] mx-auto mb-2" />
                <p className="font-bold text-sm text-[#171513]">सुरक्षित प्रसाद पैकिंग</p>
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
          <div className="hidden md:block">
            ...
            <p className="text-xs font-semibold text-[#665E58]">
              चयनित पैकेज: <span className="text-[#B85C24] font-black">{currentSelectedPkgObj?.name} (₹{Number(currentSelectedPkgObj?.price).toLocaleString('en-IN')})</span>
            </p>
          </div>
