...
`
    ...
    const fallbackText = `हरि ओम्! 🙏 दिव्ययज्ञम् (www.divyayagyam.com) के वर्चुअल पंडित जी कक्ष में आपका स्वागत है। किसी भी सहायता के लिए हमें WhatsApp +91-95304-01984 पर संपर्क करें।`
...
function getSiteAwareFallback(userQuery: string, mode: Mode): string {
  ...
  if (q.includes('शादी') || q.includes('विवाह') || q.includes('marriage') || q.includes('रिश्ता') || q.includes('कात्यायनी') || q.includes('katyayani')) {
    return `हरि ओम्! 🙏 **विवाह बाधा निवारण एवं माँ कात्यायनी यज्ञ**\n\nयदि विवाह में विलंब हो रहा है या योग्य जीवनसाथी मिलने में बाधा आ रही है, तो माँ कात्यायनी की पूजा अत्यंत फलदायी है।\n\nदिव्ययज्ञम् पर विद्वान आचार्यों द्वारा नाम-गोत्र से **Katyayani Yagya** का अनुष्ठान कराया जाता है। अपनी जन्म-कुण्डली के आधार पर विशेष जानकारी के लिए हमारी वेबसाइट पर **Pujas → Katyayani Yagya** देखें या WhatsApp (+91-95304-01984) करें। कल्याणम अस्तु! 🌸`
  }
