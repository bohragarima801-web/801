    ...
    <Card className="w-full max-w-md">
      ...
      <CardContent>
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <Button type="submit" className="w-full" disabled={loading || magicLoading || googleLoading}>
        ...
        <div className="mt-4 flex flex-col gap-3">
          ...
          <Button variant="outline" type="button" disabled={loading || magicLoading || googleLoading} onClick={handleMagicLink}>
            {magicLoading ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : <Mail className="mr-2 h-4 w-4" />}
            Email Magic Link
          </Button>
          
          <Button variant="outline" type="button" disabled={loading || magicLoading || googleLoading} onClick={handleGoogle}>
