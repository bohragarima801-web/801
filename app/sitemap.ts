...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const sitemapEntries: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/vip-pujas`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },
    { url: `${baseUrl}/tools`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },
    { url: `${baseUrl}/blog`, lastModified: new Date(), changeFrequency: 'daily', priority: 0.8 },
    { url: `${baseUrl}/bhaktiseva`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.7 },
    { url: `${baseUrl}/ask-a-pandit`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/astro`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.7 },
