...
export default function CheckoutPage() {
  ...
  // ✅ FIXED: initiatePayment with cart total validation
  const initiatePayment = () => {
    ...
    // ✅ CRITICAL FIX: Cart amount validation - YAHAN SE
    if (cartTotal <= 0) {
      toast.error('आपका कार्ट खाली है या ₹0 का है। कृपया कोई प्रोडक्ट जोड़ें।')
      return
    }

    if (cartTotal < 1) {
      toast.error('न्यूनतम ऑर्डर राशि ₹1 है। कृपया और प्रोडक्ट जोड़ें।')
      return
    }
    // ✅ YAHAN TAK
