...
export default async function PujasPage() {
  ...
  return (
    <div className="bg-[#F8F4EC] text-[#171513] min-h-screen notranslate" translate="no">
      ...
      <section className="relative bg-gradient-to-b from-white via-[#F8F4EC] to-[#F8F4EC] py-14 md:py-20 overflow-hidden border-b border-[#E8E1D5]">
        {/* Subtle Om watermark */}
        ...
        <div className="container relative z-10 text-center max-w-4xl mx-auto px-4">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-[#E8E1D5] shadow-2xs mb-4">
            <span className="text-[#B85C24] text-xs font-black uppercase tracking-wider">🪔 प्रामाणिक वैदिक पूजा एवं महायज्ञ</span>
          </div>

          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#171513] leading-tight mb-3">
            पवित्र पूजा एवं <span className="text-[#B85C24]">वैदिक अनुष्ठान</span>
          </h1>

          <p className="text-sm sm:text-base text-[#6E665D] max-w-2xl mx-auto leading-relaxed font-medium">
          ...
          <div className="flex flex-wrap gap-2.5 sm:gap-3 justify-center mt-7">
            {['वेद प्रमाणित पंडित', 'नाम-गोत्र संकल्प', 'व्हाट्सएप वीडियो प्रमाण', 'सिद्ध प्रसाद घर डिलीवरी'].map((t) => (
              <span key={t} className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-white rounded-full border border-[#E8E1D5] text-xs font-bold text-[#171513] shadow-2xs">
                <ShieldCheck className="h-3.5 w-3.5 text-[#B85C24] shrink-0" />
                {t}
              </span>
            ))}
          </div>
      ...
      {/* ── Puja Cards Grid ── */}
      <section className="bg-[#F8F4EC] py-12 md:py-16">
        <div className="container px-4 md:px-6 max-w-7xl mx-auto">
          {pujas.length === 0 ? (
            <div className="max-w-md mx-auto text-center py-16 bg-white rounded-3xl border border-[#E8E1D5] p-8 shadow-xs">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 mt-5 px-6 py-3 rounded-xl bg-[#B85C24] text-white text-xs font-bold shadow-md hover:bg-[#a04e1c] transition-all"
              >
