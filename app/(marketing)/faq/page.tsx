...
export default async function FaqPage() {
  ...
  const defaultFaqs = [
    ...
    },
    {
      ...
      answer: 'पूजा शुरू होने से 2 घंटे पहले तक आप व्हाट्सएप (+91-95871-71984) या ईमेल (Seva@divyayagyam.com) के माध्यम से अपनी बुकिंग रद्द या रीशेड्यूल कर सकते हैं। रद्द करने पर 100% रिफंड आपके बैंक खाते में 5-7 कार्य दिवसों में जमा कर दिया जाता है।'
    },
    {
      id: 'faq-7',
