...
export function generateMetadata() {
  return generatePageMeta({
    title: 'संपर्क करें (Contact Us) | DivyaYagyam',
    description: 'दिव्य यज्ञम सहायता केंद्र। ऑनलाइन पूजा बुकिंग, नाम-गोत्र संकल्प या ज्योतिष परामर्श हेतु संपर्क करें। Email: seva@divyayagyam.com, Phone: +91-95871-71984.',
    path: '/contact',
  })
}
