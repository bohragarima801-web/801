          ...
          {customContent ? (
            ...
            <>
              ...
              <section className="space-y-2">
                ...
                <p>
                  Welcome to <strong>DivyaYagyam</strong> (<Link href={process.env.NEXT_PUBLIC_URL_4544 || ''} className="text-[var(--primary-color)] hover:underline">{process.env.NEXT_PUBLIC_URL_4545 || ''}</Link>), a spiritual platform owned and operated by Pandit Mukesh Bohra. This document serves as a legally binding contract (EULA) between you and DivyaYagyam. By accessing or using our platform to book Vedic rituals, pujas, or spiritual services, you agree to these terms. If you do not agree, please do not use our services.
                </p>
              </section>
              ...
              <section className="space-y-4 pt-4 border-t">
                ...
                <div className="grid gap-4 sm:grid-cols-2 text-xs md:text-sm">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="flex items-center gap-2"><Eye className="h-4 w-4 text-[var(--primary-color)]" /> Website: <a href={process.env.NEXT_PUBLIC_URL_4545 || ''} className="hover:underline text-[var(--primary-color)]">{process.env.NEXT_PUBLIC_URL_4546 || ''}</a></p>
                  </div>
                </div>
              </section>
            </>
